...
const ProductDetails = ({ route }) => {
  ...
  return (
    ...
    >
      <View>
        <View style={{zIndex: 1, position: "absolute", width: "90%", alignItems: "flex-end", justifyContent: "flex-start", backgroundColor: "#fff"}}>
          <CartButton cartItems={cartItems} style={styles.cartButton}/>
        </View>
